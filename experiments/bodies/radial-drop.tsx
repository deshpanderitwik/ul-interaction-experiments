...
// Bodies · Radial Drop — a fork of Extended Grid where you PLACE a body by
// long-pressing empty grid: a radial of subdivisions blooms around your finger,
// and tapping one drops the body at the press point already set to that pulse.
// Everything else (the C0–C5 scrolling grid, drift, paths/move/extend, mute) is
// Extended Grid. Long-pressing an existing body still opens its options sheet.
...
export default function RadialDrop() {
